...
![Wirrwarr](picture/i.1.png) ![G](picture/i.png)
...
При данном действии, если на одних и тех же строчках сливаемых веток будет разная информация, произойдёт конфликт: Git не сможет определиться сам, какую информацию ему оставить, какую убрать, потому попросит вас сделать эо самостоятельно.
